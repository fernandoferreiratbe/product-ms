package io.github.fernandoferreira.compasso.productms.services.integrationtest;
...
class ProductServiceIntegrationTest {
    ...
    void givenValidId_ShouldNotFindProductDuringUpdate_ThrowsProductNotFoundException() {
        Assertions.assertThrows(ProductNotFoundException.class, () ->
                this.productService.update(-1L, new ProductRequest("Name", "Desc", 20.10)));
    }

    @Test
    @DisplayName("Given valid id should not find product during delete operation and throws product not found exception")
    void givenInvalidId_ShouldNotFindProductDuringDelete_ThrowsProductNotFoundException() {
